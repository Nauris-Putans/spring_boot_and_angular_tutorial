...
import io.getarrays.server.emumeration.Status;
...
import static io.getarrays.server.emumeration.Status.*;
...
public class ServerManagerApplication {
    ...
    CommandLineRunner run(ServerRepo serverRepo) {
        return args -> {
            ...
            serverRepo.save(new Server(null, "192.168.1.69", "MS 2008", "32 GB", "Web Server", "http://localhost:8080/server/image/server3.png", SERVER_UP));
